...
public class FormTransaksi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(textfieldIDTransaksi, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, 180, 30));
        ...
        jPanel1.add(labelKodeBuku1, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 120, -1, 20));
        ...
        labelKodeBuku2.setForeground(new java.awt.Color(71, 127, 255));
        labelKodeBuku2.setText("Data Anggota");
        jPanel1.add(labelKodeBuku2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 190, -1, 20));

        labelKodeBuku6.setFont(new java.awt.Font("Montserrat SemiBold", 0, 14)); // NOI18N
        labelKodeBuku6.setForeground(new java.awt.Color(71, 127, 255));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 450, 900, 90));
        ...
        jPanel1.add(labelKodeBuku3, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 120, -1, 20));
        ...
        buttonSearchKodeBuku.setBackground(new java.awt.Color(71, 127, 255));
        ...
        jPanel1.add(panelAnggota1, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 210, 370, 230));
        ...
        labelKodeBuku4.setText("Kelas");
        panelAnggota.add(labelKodeBuku4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, -1, 20));
        ...
        panelAnggota.add(labelKodeBuku5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, -1, 20));
        ...
        labelKelas.setFont(new java.awt.Font("Segoe UI Light", 1, 14)); // NOI18N
        labelKelas.setText("-");
        panelAnggota.add(labelKelas, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 150, 180, 20));

        labelNoTeleponAnggota.setFont(new java.awt.Font("Segoe UI Light", 1, 14)); // NOI18N
        labelNoTeleponAnggota.setText("-");
        panelAnggota.add(labelNoTeleponAnggota, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 180, 180, 20));

        buttonSearchAnggota.setBackground(new java.awt.Color(71, 127, 255));
        ...
        jPanel1.add(panelAnggota, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 210, 350, 230));
        ...
        jPanelStatusLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelStatusLayout.createSequentialGroup()
                ...
                .addComponent(labelTerlambat1)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(labelLamaPinjam, javax.swing.GroupLayout.PREFERRED_SIZE, 341, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        jPanelStatusLayout.setVerticalGroup(
            ...
            .addGroup(jPanelStatusLayout.createSequentialGroup()
                ...
                .addGroup(jPanelStatusLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(labelLamaPinjam, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(labelTerlambat1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(0, 5, Short.MAX_VALUE))
            .addComponent(jLabel2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );

        jPanel1.add(jPanelStatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 80, 840, 30));
    ...
    private void buttonSearchAnggotaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSearchAnggotaActionPerformed
        ...
        try{
            ...
            if(hasil.next()){
                ...
                labelNama.setText(a);
                labelNIS.setText(b);
                labelKelas.setText(c);
                labelNoTeleponAnggota.setText(d);
            }else{
    ...
    private void tableTransaksiPeminjamanBukuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableTransaksiPeminjamanBukuMouseClicked
        ...
        //Jika tgl kembali sudah lewat maka muncul warning merah
        selisihTanggal();
        ...
        try{
            ...
            if(hasil.next()){
                ...
                String cy = hasil.getString("kelas");
                String dy = hasil.getString("no_tlp");

                labelNama.setText(ay);
                labelNIS.setText(by);
                labelKelas.setText(cy);
                labelNoTeleponAnggota.setText(dy);
            }else{
